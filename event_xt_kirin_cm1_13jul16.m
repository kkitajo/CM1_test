...
for s=1:length(trigger)
   f_name=strcat('CM1_S',num2str(trigger(s)),'.mat');    % for save % Input % 
   f_name2=strcat('CM1_S',num2str(trigger(s)),'_sub',num2str(sub),'_filt','.mat');    % for save % Input % 
    for n=1:b %1:b % epoch roop
        ...
        if 1==strcmp(str_ev,'S 29');
            str_ev='S 61';
        elseif 1==strcmp(str_ev,'S 81');
            str_ev='S101';
        elseif 1==strcmp(str_ev,'S 69');
            str_ev='S105';
        end
